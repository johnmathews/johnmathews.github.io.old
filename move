...
<html id="baz" class="" lang="en">
  <head>
      ...
      <title>Move - JohnMathews.eu</title>
      <meta name="title" content="Move -  JohnMathews.eu "/>
      <meta property="og:title" content="Move"/>
      <meta property="twitter:title" content="Move"/>

      <meta name="keywords" content=" Lifestyle "/>
      <meta name="author" content="John Mathews"/>
      <meta name="twitter:creator" content="@johnmathews"/>

      <meta name="description" content=" Training’s over "/>
      <meta name="twitter:description" content=" Training’s over "/>
      <meta property="og:description" content=" Training’s over "/>

      <meta property="og:url" content="https://johnmathews.eu/move"/>
      <meta property="twitter:url" content="https://johnmathews.eu/move"/>

      <meta name="twitter:image" content=" 
    https://johnmathews.eu//images/square_mile.jpg"/>
    ...
    https://johnmathews.eu//images/square_mile.jpg"/>
      ...
      <link rel="icon" href="https://johnmathews.eu/extra/favicon.png" />

      <link rel="alternate" type="application/atom+xml" title="John Mathews Feed" href="https://johnmathews.eu/feed/all.atom.xml" />
  ...
  <body class="dark:bg-gray-800">
    ...
    <nav id="navbar" style="transition: top 0.3s ease-in-out;" class="z-50 py-2 text-xl top-0 w-full lg:fixed flex flex-wrap items-center justify-between p-5 bg-gradient-to-r from-yellow-400 to-pink-400">
      <div>
        <a class="prose prose-xl text-gray-700 hover:text-white font-semibold block md:inline-block px-3 py-1" href="https://johnmathews.eu/blog">JohnMathews.eu</a>
      </div>
      ...
      <div class="toggle hidden md:flex w-full md:w-auto text-right text-bold border-t-2 border-blue-900 md:border-none">

        <a class="prose prose-xl text-gray-700 hover:text-white font-semibold block my-auto md:inline-block px-3 py-1 border-b-2 border-blue-900 md:border-none" href="https://johnmathews.eu/portfolio.html">Portfolio</a>
        <a class="prose prose-xl text-gray-700 hover:text-white font-semibold block my-auto md:inline-block px-3 py-1 border-b-2 border-blue-900 md:border-none" href="https://johnmathews.eu/about.html">About</a>
        <a class="prose prose-xl text-gray-700 hover:text-white font-semibold block my-auto md:inline-block px-3 py-1 border-b-2 border-blue-900 md:border-none" href="https://johnmathews.eu/experience.html">Experience</a>

        <div class="flex justify-end px-3">
          <button class="pl-5 md:pl-0 inline-block pr-3 py-3 md:pb-0 md:pt-1" id="theme-toggle" aria-label="themeToggle" onclick="modeSwitcher()">
            <div id="day" class="modeIcon">
              <i class="far fa-lightbulb fa-lg"></i>
            </div>
            <div id="night" class="modeIcon hidden">
              <i class="far fa-moon fa-lg"></i>
            </div>
          </button>

          <button id="catChooser" class="md:mt-0" aria-label="Category chooser">
              <i class="pl-2 fas fa-paw fa-lg"></i>
          </button>
        </div>
  ...
  <div id="articleParent" class="-ml-5 -mr-5 lg:mx-auto max-w-4xl px-10 my-4 py-6 rounded-lg shadow-md dark:bg-gray-700   nonTechnical ">
      <img class="lg:mx-auto" src="/images/square_mile.jpg" alt="London's Square Mile" />
    ...
    <div class="py-1 text-gray-700 font-bold text-center dark:text-gray-200">
      Category:
        <a href="https://johnmathews.eu/category/non-technical/family.html">Family</a>
    ...
    <main>
      <article>
          <div class="markdown dark:text-gray-200">
            <p>Training&rsquo;s&nbsp;over</p>
          </div>
        <div class="markdown dark:text-gray-200">
          <h1 id="ambition">Ambition</h1>
<p>Since I was 15, one of my ambitions has been to be an entrepreneur. I used to joke with my dad about buying him a nice boat one&nbsp;day.</p>
<p>Life so far has been predominantly about education, and that stage is over now. I’m walking away from what I&rsquo;ve come to see as a lifestyle and career that has too many contradictions, it doesn&rsquo;t make sense to live like this. Ultimately I want to develop multiple sources of passive income. I want to&nbsp;create.</p>
<h2 id="summer-2017">Summer&nbsp;2017</h2>
<p>The last few months have been intense, with some weeks leaving me feeling ambitious and energetic, and others feeling anxious and overwhelmed. I need to get better at defining a goal, taking the quickest path there, and ignoring interesting&nbsp;distractions.</p>
<p>Ritsya is brave enough and imaginative enough to force me to think big and consider how to live a better life. My biggest fear is that I screw it up, shooting myself in the foot and Ritsya and my daughter also. We were headed safely to an unremarkable existence and it would be terrible to swap that for something worse. That won&rsquo;t&nbsp;happen.</p>
<p>I know that I make better decisions and produce my best work under pressure, I thrive when I&rsquo;m perceived as an underdog. I need to accept this without using it as a reason to be foolish. Whilst I don’t have a clear plan, or direction, or goal, (I have many of them) I’ve got skills and I want to see what I can make. I’ll never do my best work, using my most productive combination of skills and experiences, if I’m a cog in someone else&rsquo;s&nbsp;machine.</p>
<p>It’s safer being an employee than self-employed. I guess the price of removing self-employment risks is the difference between the value you generate for your employer and what you’re paid. I think those risks are overpriced, and most people are more capable than they realise. Sometimes you have to walk into a situation to find out how to make the most of it. And sometimes you have to leave a place in order to gain&nbsp;perspective.</p>
<h2 id="autumn-2016">Autumn&nbsp;2016</h2>
<p>Last year my boss gave me some advice that was supposed to be encouraging. I’d requested to reduce my involvement with some stuff that was unrelated to my job so that I could contribute more to my team and still maintain some semblance of a work/life&nbsp;balance.</p>
<p>My boss was pretty clear that reducing my involvement in the extra stuff would not be possible. During our conversation he advised me not to worry about how much I contributed to the team because “the work will get done anyway”. This was meant to be encouraging, but instead removed any conviction that the work I did was&nbsp;important.</p>
        </div>
      </article>
    </main>
    ...
    <div class="mb-10 text-lg dark:text-gray-200">
        <div class="flex flex-row">
          ...
          <a class=" dark:text-gray-200 px-1 hover:text-green-700 dark:hover:text-red-500" href="https://johnmathews.eu/flee"> Flee</a>
        </div>
        <div class="flex flex-row">
          <div class="text-green-500 dark:text-green-200"> &#x2192; </div>
          <a class="dark:text-gray-200 text-left px-1 hover:text-green-700 dark:hover:text-green-200" href="https://johnmathews.eu/corporate"> Corporate&nbsp;London</a>
        </div>
    </div>

    <div class="text-left">
      <button id="signupButton" class="inline-flex items-center h-10 px-5 text-gray-700 dark:text-gray-700 transition-colors duration-150 bg-yellow-500 hover:bg-yellow-600 rounded-lg focus:shadow-outline dark:hover:text-gray-200">
        <span>Subscribe</span>
      ...
      <script>
        ...
        *  RECOMMENDED CONFIGURATION VARIABLES: EDIT AND UNCOMMENT THE SECTION BELOW TO INSERT DYNAMIC VALUES FROM YOUR PLATFORM OR CMS.
                ...
                var disqus_config = function () {
                          this.page.url = "https://johnmathews.eu/move";  // Replace PAGE_URL with your page's canonical URL variable
                          this.page.identifier = "move"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
                        };
    ...
    <div>
        ...
        <script async>
          // the user can only choose article visibility settings on the index page
          if (window.location.pathname !== '/blog') {
            $("#catChooser").toggleClass('hidden')
          };
        </script>
