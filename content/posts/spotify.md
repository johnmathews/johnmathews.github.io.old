...
<div class="output_subarea output_stream output_stdout output_text">
    ...
    There are 0 rows with NaN values in 2016 (NaT's not considered)
...
Most of my attempts to verify Spotify’s statistics fall short because
the data only covers the second half of 2016. This shows that good
quality inputs are required o achieve good quality results.

Having said that, it is clear that I listen to Spotify far more than I
thought I did. The observation that I like many of Bonobo’s tracks but
have more polarised views about Bombay Bicycle Club’s songs is novel.
For £5/month, I’m getting great value!

My top 101 songs of 2016 can be played on
Spotify [here](https://open.spotify.com/user/spotify/playlist/37i9dQZF1CyJD4o58dMxry).
