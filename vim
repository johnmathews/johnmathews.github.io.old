...
<html id="baz" class="" lang="en">
  <head>
      ...
      <title>Vim! - JohnMathews.eu</title>
      <meta name="title" content="Vim! -  JohnMathews.eu "/>
      ...
      <meta name="description" content=" Vim is a text editor renowned for its efficiency and its use of keyboard shortcuts. It’s based on the Vi text editor from the 1970’s. It was first released in 1991 and is still being developed... "/>
      <meta name="twitter:description" content=" Vim is a text editor renowned for its efficiency and its use of keyboard shortcuts. It’s based on the Vi text editor from the 1970’s. It was first released in 1991 and is still being developed... "/>
      <meta property="og:description" content=" Vim is a text editor renowned for its efficiency and its use of keyboard shortcuts. It’s based on the Vi text editor from the 1970’s. It was first released in 1991 and is still being developed... "/>

      <meta property="og:url" content="https://johnmathews.eu/vim"/>
      <meta property="twitter:url" content="https://johnmathews.eu/vim"/>
...
"/>
  ...
  <div id="articleParent" class="-ml-5 -mr-5 lg:mx-auto max-w-4xl px-10 my-4 py-6 rounded-lg shadow-md dark:bg-gray-700  technical  ">
    ...
    <main>
      <article>
        <div class="markdown dark:text-gray-200">
          <p>Vim is a text editor renowned for its efficiency and its use of keyboard
shortcuts. It&rsquo;s based on the Vi text editor from the 1970&rsquo;s. It was first
...
tutorial</a>. There&rsquo;s also a built-in vim tutorial - just
type &lsquo;vimtutor&rsquo; into&nbsp;Terminal.</p>
<p>Vim is designed so that you don&rsquo;t need to take your hands off your keyboard and
use a mouse. It has the &lsquo;insert&rsquo; mode where you enter text as usual, and the
&lsquo;command&rsquo; mode where you can make use of a comprehensive and flexible shortcut
language to move around, edit and search the text. With no <span class="caps">GUI</span> or toolbar, it&rsquo;s
a very different approach to text editing than I&rsquo;m used&nbsp;to.</p>
...
a normal program, and lets the arrow keys move the cursor in addition to <span class="caps">VIM</span>&rsquo;s
&lsquo;hjkl&rsquo; functionality. This makes getting started a little&nbsp;simpler.</p>
<p>There are also a lot of plugins to extend Vim&rsquo;s functionality and turn it from
...
for a quick overview of how to use&nbsp;Vim.</p>
        </div>
      </article>
    </main>
    ...
    <div class="mb-10 text-lg dark:text-gray-200">
        <div class="flex flex-row">
          ...
          <a class=" dark:text-gray-200 px-1 hover:text-green-700 dark:hover:text-red-500" href="https://johnmathews.eu/autumn-bin-and-path"> Autumn, <span class="caps">BIN</span> and $<span class="caps">PATH</span></a>
        </div>
        <div class="flex flex-row">
          <div class="text-green-500 dark:text-green-200"> &#x2192; </div>
          <a class="dark:text-gray-200 text-left px-1 hover:text-green-700 dark:hover:text-green-200" href="https://johnmathews.eu/rys-git-tutorial"> Ry&#8217;s Git&nbsp;Tutorial</a>
        </div>
    </div>
      ...
      <script>
        ...
        *  RECOMMENDED CONFIGURATION VARIABLES: EDIT AND UNCOMMENT THE SECTION BELOW TO INSERT DYNAMIC VALUES FROM YOUR PLATFORM OR CMS.
                ...
                var disqus_config = function () {
                          this.page.url = "https://johnmathews.eu/vim";  // Replace PAGE_URL with your page's canonical URL variable
                          this.page.identifier = "vim"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
                        };
